...
import styles from './primeBtn.module.scss'
const PrimeBtn = ({isDisabled }) => {
    return (
        <button className={styles.btn} disabled={isDisabled}>
            { isDisabled ? (
                <svg className={styles.spinner} width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
